...
macronews = pd.read_csv("../PData/Duplicates_Removed_MacroNews09_11_2017_11_06_2018.csv", header=0, index_col ="DateTime")
...
USDGBP_ratio = np.divide(np.multiply(fx_news_concatenate['USDEUR_Close_Ask'],fx_news_concatenate['EURGBP_Close_Ask']), fx_news_concatenate['USDGBP_Close_Ask'])
